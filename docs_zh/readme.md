...
[![项目状态: 活跃 – 该项目已经稳定且可用的状态，仍在活跃开发中。](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active)
[![社区讨论](https://img.shields.io/badge/community-forum-009639?logo=discourse&link=https%3A%2F%2Fcommunity.nginx.org)](https://community.nginx.org)
[![授权协议](https://img.shields.io/badge/License-BSD%202--Clause-blue.svg)](/LICENSE)
[![行为准则](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](/CODE_OF_CONDUCT.md)

NGINX（发音为“engine x”或“en-jin-eks”）是全球最受欢迎的 Web 服务器、高性能负载均衡器、反向代理、API 网关及内容缓存系统。
